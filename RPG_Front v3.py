...
class Ecran(Frame) :
    ...
    def CadreAction(self) :
        ...
        self.bouttonCarac = Button(self.cadre_Action, text = "Caracteristique", fg = "red", command = self.Affi_Cara)
    ...
    def insertResultat(self, resultat):
        global message
        self.texte_res.insert(END, message)

    def Affi_Cara(self) :
        Gandalf.Affiche_Caractéristiques()
        self.insertResultat()
